...
interface UncategorizedTaskGroupProps {
  tasks: Task[];
...
export function UncategorizedTaskGroup({ 
  tasks, 
  onToggle, 
  showAssignee = false, 
  showNotes = false 
}: UncategorizedTaskGroupProps) {
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.roomInfo}>
          ...
          <Text style={styles.roomName}>Uncategorized</Text>
        </View>
      ...
      {expanded && visibleTasks.length === 0 && (
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyText}>No uncategorized tasks</Text>
        </View>
      )}
    </View>
  );
